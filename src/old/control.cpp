...
ros::NodeHandle n;
  ros::Subscriber sub5 = n.subscribe("/turtlebot_teleop/cmd_vel", 10, Key_Handler);        //keyboard topic


  ros::Publisher pub1=n.advertise<geometry_msgs::Twist>("/robot1/cmd_vel", 10);///robot2/cmd_vel
